...
| `webpage.jsx` | `/webpage/:id?` | Webpage editor + AI tools | Full editing with correct/translate/split/clean |
...
- **Props**: `formik, handleSplitTextForEmbedding, handleCorrectUsingAI, handleTranslate, handleRemoveNotNeededText, isLoading`
...
- **AI Tool Buttons**: Split for Embedding, Correct using AI, Translate (PL→EN), Clean Text
...
|------|---------|---------------|
| `useManageLLM` | Document CRUD + AI processing | `/website_get`, `/website_save`, `/website_delete`, `/ai_ask`, `/translate`, `/website_split_for_embedding`, `/website_text_remove_not_needed` |
