...
│   └── sql_filters.py  # the ONE shared filter builder (stage 6); stage 7A adds publisher_name/domain via publisher_id subqueries (all matching ids, never arbitrary first). author_name/discovery_source_name remain explicit NotImplementedError until session B.
