  ...
  return (
    <>
      ...
      <div className="flexBox">
        ...
        {formik.values.previous_id && (
          <button
            disabled={isLoading}
            className="rts-btn btn-primary w-25"
            style={{ marginTop: "13px", marginLeft: "10px" }}
            onClick={() => handleGetLinkByID(formik.values.previous_id)}
          >
            ({formik.values.previous_id}) previous
          </button>
        )}
        {formik.values.next_id && (
          <button
            disabled={isLoading}
            className="rts-btn btn-primary w-25"
            style={{ marginTop: "13px", marginLeft: "10px" }}
            onClick={() => handleGetLinkByID(formik.values.next_id)}
          >
